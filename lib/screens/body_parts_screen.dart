...
class BodyPartsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:
          AppBar(title: Text('🧍 ${s.t('Anggota Badan', 'Body Parts')}')),
      body: GridView.builder(
        ...
        itemCount: bodyPartItems.length,
        itemBuilder: (context, i) {
          final item = bodyPartItems[i];
